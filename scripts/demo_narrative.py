...
Loads a fitted expert tree for Cu, scores a handful of known sites and random
points, then prints PointNarrative output in plain text and saves a markdown
report.
